"""Golden tests for navigation fields (TOC levels, LOF, LOT, mixed)."""
...
GOLDEN_CASES = {
    "nav-toc-levels": build_toc_levels_document,
    "nav-list-of-figures": build_list_of_figures_document,
    "nav-list-of-tables": build_list_of_tables_document,
    "nav-mixed-navigation": build_mixed_navigation_document,
}
...
def test_navigation_document_xml_matches_golden(
    case: str,
    fixtures_dir: Path,
    expected_dir: Path,
    tmp_path: Path,
